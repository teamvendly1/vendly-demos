...
(function () {
  ...
  function injectCss(accent, theme) {
    ...
    var css =
      ...
      ".sa-panel{left:0;right:0;bottom:0;top:auto;width:100%;max-width:100%;height:88vh;height:min(88vh,100dvh);" +
      "max-height:88vh;max-height:min(88vh,100dvh);border-radius:16px 16px 0 0}" +
